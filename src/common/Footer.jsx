  ...
  return (
    <div className="font-work-sans max-w-7xl mx-auto">
      <div className="grid py-20  items-start gap-10 text-gray-600 px-4 md:px-10 grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="flex flex-col gap-3 mt-3">
          <h3 className="text-lg text-[#151035] font-medium">Contact Us</h3>
          <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-3 mt-3">
          <h3 className="text-lg text-[#151035] font-medium">Telephone</h3>
          <div className="flex flex-col gap-2">
            <h3 className="text-lg text-[#151035] ">Lagos Office:</h3>
