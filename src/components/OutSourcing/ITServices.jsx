          ...
          <div>
            ...
            <div className="px-4 flex flex-col gap-3">
              ...
              <p className="text-gray-600">
                ...
                comprehensive cybersecurity services. We proactively monitor and
                defend your systems, keeping your sensitive data safe from
                potential breaches.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="px-4 flex flex-col gap-3">
              ...
              <p className="text-gray-600">
                ...
                secure network infrastructure tailored to your specific business
                needs. We focus on optimizing performance, ensuring data
                security, and streamlining communication across your
                organization.
              </p>
            </div>
          </div>
