  ...
  return (
    <div className="bg-[#F5F8FB] px-4 md:px-10 flex flex-col justify-center items-center gap-5 py-10">
      ...
      <p className="px-4 lg:px-[180px] text-gray-600 text-center">
        ...
        organization. Our solutions make your business run smoother by unifying
        and protecting your information; automating processes and reports;
        managing important information through total systems integration; and
        providing easy views into trends. With these and many more capabilities,
        your day-to-day operations and long-term planning becomes easier and
        faster
      </p>
          ...
          <div>
            ...
            <div className="px-4 flex flex-col gap-3">
              ...
              <p className="text-gray-600">
                We provide a graphical representation of your company's business
                processes or workflows, as a means of identifying potential
                improvements.
              </p>
            </div>
          </div>
        ...
        <CourseCard>
          <div>
            ...
            <div className="px-4 flex flex-col gap-3">
              ...
              <p className="text-gray-600">
                Integrate business processes and allow quick decision making and
                customer engagement in real-time backed by adequate data—from
                marketing, sales, service, operations, to finance.
              </p>
            </div>
          </div>
        </CourseCard>
